...
{
#ifndef _WIN32
    // NOTE: This is needed because if the pipe between Neo Flux and FFmpeg breaks
    // Neo Flux will receive SIGPIPE on trying to write into it. While such behavior
    // makes sense for command line utilities, Neo Flux is a relatively friendly GUI
    ...
    size_t factor = 80;
    InitWindow(factor*16, factor*9, "Neo Flux");
    {
